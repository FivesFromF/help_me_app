...
class PrivacyPolicyPage extends StatefulWidget {
  ...
  const PrivacyPolicyPage({super.key, this.isConsentMode = false});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        automaticallyImplyLeading: !widget.isConsentMode,
        leading: widget.isConsentMode
            ? null
            : IconButton(
                icon:
                    const Icon(Icons.arrow_back, color: AppColors.primaryBlack),
                onPressed: () {
                  if (context.canPop()) {
                    context.pop();
                  } else {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const _RichText(
                      ...
                      content:
                          'Họ tên, ngày sinh, số CCCD, số điện thoại, ảnh đại diện.',
                    ),
                    const _RichText(
                      title: 'Dữ liệu y tế',
                      content:
                          'Nhóm máu, bệnh nền, tiền sử bệnh lý, dị ứng thuốc, thông tin người liên lạc khẩn cấp.',
                    ),
                    const _RichText(
                      title: 'Dữ liệu sinh trắc học',
                      content:
                          'Ảnh khuôn mặt 5 góc được chuyển đổi thành vector đặc trưng mã hoá. Ảnh gốc bị xoá ngay sau khi xử lý.',
                    ),
                    const _RichText(
                      title: 'Dữ liệu sử dụng',
                      content:
                          'Nhật ký truy cập hồ sơ, thời điểm và vai trò của người tra cứu.',
                    ),
                    const SizedBox(height: 20),
                    ...
                    const _Bullet(
                        'Sự đồng ý của bạn — khi đăng ký và khai báo thông tin'),
                    const _Bullet(
                        'Tình huống khẩn cấp — Nghị định 13 cho phép xử lý dữ liệu không cần đồng ý khi mục đích là bảo vệ tính mạng, sức khoẻ con người'),
                    const SizedBox(height: 20),
                    ...
                    const _Bullet(
                        'Nhân viên y tế / cấp cứu được xác minh trong tình huống khẩn cấp'),
                    const _Bullet(
                        'Bệnh viện đối tác có ký hợp đồng bảo mật ràng buộc'),
                    const _Bullet(
                        'Yêu cầu của cơ quan nhà nước có thẩm quyền theo quy định pháp luật'),
                    const SizedBox(height: 20),
                    ...
                    const _Bullet(
                        'Phản đối việc xử lý dữ liệu trong các trường hợp không khẩn cấp'),
                    const _BodyText(
                    ...
                    const _BulletText(
                        title: 'Email', content: 'privacy@helpme.vn'),
                        ...
                        child: const Row(
                          ...
                          children: [
                            Icon(Icons.arrow_upward,
                                size: 20, color: AppColors.primaryBlack),
                            SizedBox(width: 4),
                            Text(
                              'Cuộn lên đầu trang',
                              style: TextStyle(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            'Tôi đồng ý với quy định của hệ thống và sẽ chịu trách nhiệm hoàn toàn cho mọi hành vi của mình!',
                            style: TextStyle(
                              fontSize: 13,
